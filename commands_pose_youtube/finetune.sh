...
--load_subtitles True \
--lr 1e-6 \
--save_path '/scratch/shared/beegfs/zifan/checkpoints/subtitle_align_pose_youtube/finetune_subtitles/' \
--n_epochs 100 \
...
--resume '/scratch/shared/beegfs/zifan/checkpoints/subtitle_align_pose_youtube/train_coarse_subtitles/checkpoints/model_0000195509.pt' \
