...
--save_probs True \
--dtw_postpro True \
--save_path '/scratch/shared/beegfs/zifan/checkpoints/subtitle_align_swin/finetune_subtitles_adapt_feat_v2_1/' \
--resume '/scratch/shared/beegfs/zifan/checkpoints/subtitle_align_swin/finetune_subtitles_adapt_feat_v2_1/checkpoints/model_0000253841.pt' \
