...
--load_subtitles True \
--lr 1e-6 \
--save_path '/scratch/shared/beegfs/zifan/checkpoints/subtitle_align_sign_clip/finetune_subtitles_adapt/' \
--n_epochs 100 \
...
--features_path '/users/zifan/BOBSL/derivatives/video_features/sign_clip_bobsl' '/users/zifan/BOBSL/derivatives/video_features/auto_asvr' \
--feature_dim_adapt 1536 \
# --debug \
# --features_path '/users/zifan/BOBSL/derivatives/video_features/sign_clip_bobsl' \
# --features_path '/users/zifan/BOBSL/derivatives/video_features/auto_asvr' \
