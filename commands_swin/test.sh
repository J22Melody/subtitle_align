...
--resume '/scratch/shared/beegfs/zifan/checkpoints/subtitle_align_swin/finetune_subtitles/checkpoints/model_0000251241.pt' \
# --resume '/scratch/shared/beegfs/zifan/checkpoints/subtitle_align_swin/finetune_subtitles/checkpoints/model_0000250674.pt' \
# --save_path '/scratch/shared/beegfs/zifan/checkpoints/subtitle_align_swin/scratch/' \
# --resume '/scratch/shared/beegfs/zifan/checkpoints/subtitle_align_swin/scratch/checkpoints/model_0000000837.pt' \
